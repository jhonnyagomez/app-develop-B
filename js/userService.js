function getUsers(page){
    document.getElementById('cardHeader').innerHTML = '<h4><i class="fa-solid fa-users"></i> Lista de Usuarios</h4>'
                ...
                response.body.data.forEach(user => {
                    listUsers = listUsers.concat(`
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-outline-danger" onclick="showInfoUser('${user.id}')"><i class="fa-solid fa-eye"></i></button>
                            </td>
                        </tr>
                        `)
                })
                  ...
                  <div class="card-body">
                    <form id="formAddUser">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="email" placeholder="Email@Input.co" required>
                      </div>
                      <div class="mb-3">
                        <label for="avatar" class="form-label">Avatar</label>
                        <input type="url" class="form-control" id="avatar" placeholder="Url" required>
                      </div>
  ...
  if(form.checkValidity()){
    ...
    .then((response) =>{
      if(response.status === 201){
        document.getElementById('info').innerHTML = '<h3>The user was registered success!.</h3>'
      }else{
        document.getElementById('info').innerHTML = '<h3>The user cant register.</h3>'
      }
